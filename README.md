...
This graph is generated by my custom web API that uses [serpapi](https://serpapi.com/google-scholar-api) and [vercel](https://vercel.com/). It will response with an image (shown above) given google scholar ID. If you want to use this in your project. You can try as below.
